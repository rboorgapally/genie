...
abstract class JobClientIntegrationTest extends ClusterClientIntegrationTest {
    ...
    private String echoCommandId;

    private String sleepJobId;
    private String killJobId;
    private String timeoutJobId;
    private String dateJobId;
    private String echoJobId;
    ...
    @Test
    @Order(2)
    void canfindJobPaginated() throws Exception {
        Assertions.assertThat(this.jobClient.getJobs().size()).isEqualTo(5);
